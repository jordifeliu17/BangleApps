...
function draw() {
  ...
  //g.drawString("ACTIVATE", 40, 35);
   ...
   g.drawString("BON",3,60);
   g.drawString("DIA ",3,80);
  g.setFontAlign(0,-1);
 // g.setFont("8x12", 2);
