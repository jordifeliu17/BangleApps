...
function getBackgroundImage() {
 ...
 return require("heatshrink").decompress(atob(""))
}  
...
function draw() {
  ...
  //g.drawString("ACTIVATE", 40, 35);
   ...
   g.drawString("BON ",10,60);
   g.drawString("DIA ",10,60);
  g.setFontAlign(0,-1);
  g.setFont("8x12", 2);
